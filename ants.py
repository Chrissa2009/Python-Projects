    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if place.ant.can_contain(self):
                place.ant.contain_ant(place.ant)
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        distance = 0
        while start != beehive:
            current_bee=rANTdom_else_none(start.bees)
            if current_bee and self.min_range <= distance<=self.max_range:
                return current_bee
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        lst_bees=list(self.place.bees)
        if self.armor > 0:
            Ant.reduce_armor(self,amount) #The first argument has to be an instance
...
class HungryAnt(Ant):
    ...
    def __init__(self, armor=1):
        ...
        "*** YOUR CODE HERE ***"
        self.digesting=0
        Ant.__init__(self, armor) #Create an Ant with an ARMOR quantity 
        # END Problem 6
...
# END Problem EC
    ...
    def action(self, gamestate):
        ...
        while start != None:
            if start.ant is not None and start.ant.double_damage==0:
                start.ant.damage=start.ant.damage*2
                start.ant.double_damage=1
            start=start.exit
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        Insect.reduce_armor(self,self.armor)
        if self.armor <= 0 and self.trueQueen is True:
            bees_win()
        # END Problem EC
